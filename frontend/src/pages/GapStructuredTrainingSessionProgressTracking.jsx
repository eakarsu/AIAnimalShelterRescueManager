...
// v0 scaffold for: No structured training-session / progress tracking
// Generated by batch_00 audit. Wire to real API; v0 calls /api/gap-structured-training-session-progress-tracking/run.

export default function StructuredTrainingSessionProgressTrackingPage() {
  ...
  async function run() {
    ...
    try {
      ...
      const res = await fetch('/api/gap-structured-training-session-progress-tracking/run', {
        method: 'POST',
        headers: {
  ...
  return (
    <div style={{ padding: '2rem', maxWidth: '900px', margin: '0 auto' }}>
      <h1 style={{ fontSize: '1.5rem', fontWeight: 600, marginBottom: '0.5rem' }}>No structured training-session / progress tracking</h1>
