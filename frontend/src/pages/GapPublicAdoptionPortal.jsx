...
// v0 scaffold for: No public adoption portal
// Generated by batch_00 audit. Wire to real API; v0 calls /api/gap-public-adoption-portal/run.

export default function PublicAdoptionPortalPage() {
  ...
  async function run() {
    ...
    try {
      ...
      const res = await fetch('/api/gap-public-adoption-portal/run', {
        method: 'POST',
        headers: {
  ...
  return (
    <div style={{ padding: '2rem', maxWidth: '900px', margin: '0 auto' }}>
      <h1 style={{ fontSize: '1.5rem', fontWeight: 600, marginBottom: '0.5rem' }}>No public adoption portal</h1>
