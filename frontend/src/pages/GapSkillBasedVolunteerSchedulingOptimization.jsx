...
// v0 scaffold for: Skill-based volunteer scheduling optimization
// Generated by batch_00 audit. Wire to real API; v0 calls /api/cf-skill-based-volunteer-scheduling-optimization/run.

export default function SkillBasedVolunteerSchedulingOptimizationPage() {
  ...
  async function run() {
    ...
    try {
      ...
      const res = await fetch('/api/cf-skill-based-volunteer-scheduling-optimization/run', {
        method: 'POST',
        headers: {
  ...
  return (
    <div style={{ padding: '2rem', maxWidth: '900px', margin: '0 auto' }}>
      <h1 style={{ fontSize: '1.5rem', fontWeight: 600, marginBottom: '0.5rem' }}>Skill-based volunteer scheduling optimization</h1>
