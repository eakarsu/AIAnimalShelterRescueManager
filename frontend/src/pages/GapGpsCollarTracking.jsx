...
// v0 scaffold for: No GPS-collar tracking
// Generated by batch_00 audit. Wire to real API; v0 calls /api/gap-gps-collar-tracking/run.

export default function GpsCollarTrackingPage() {
  ...
  async function run() {
    ...
    try {
      ...
      const res = await fetch('/api/gap-gps-collar-tracking/run', {
        method: 'POST',
        headers: {
  ...
  return (
    <div style={{ padding: '2rem', maxWidth: '900px', margin: '0 auto' }}>
      <h1 style={{ fontSize: '1.5rem', fontWeight: 600, marginBottom: '0.5rem' }}>No GPS-collar tracking</h1>
